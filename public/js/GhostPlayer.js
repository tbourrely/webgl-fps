GhostPlayer = function(game, ghostData, idRoom) {
	...
	fakePlayer.playerBox = BABYLON.Mesh.CreateBox(
		ghostData.id,
		5,
		this.game.scene
	);
	...
	fakePlayer.playerBox.material = new BABYLON.StandardMaterial(
		"textureGhost",
		this.game.scene
	);
	...
	fakePlayer.bodyChar = BABYLON.Mesh.CreateBox(
		"bodyGhost",
		2.2,
		this.game.scene
	);
	...
	fakePlayer.head.material = new BABYLON.StandardMaterial(
		"textureGhost",
		this.game.scene
	);
	fakePlayer.head.material.diffuseColor = new BABYLON.Color3(0, 1, 1);

	fakePlayer.bodyChar.material = new BABYLON.StandardMaterial(
		"textureGhost",
		this.game.scene
	);
